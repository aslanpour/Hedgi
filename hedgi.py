...
def reset():
    ...
    #fix DNS nameserver (helpful if after each host reboot the  value disappers)
    ...
    if utils.what_device_is_it('raspberry pi 3'):
        ...
        #This cmd works briefly then the power switches back on to the ports (although it does not seem), investigations are underway to find a solution. 
